<template>
  <div class="app-container">
    <el-table :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border fit highlight-current-row
      ...
      <el-table-column min-width="150px"  align="center" label="发布者">
        <template slot-scope="scope">
        ...
        <el-table-column width="110px"  align="文章类型" label="文章类型">
        <template slot-scope="scope">
      ...
      <el-table-column width="110px"  align="center" label="标签">
        <template slot-scope="scope">
            <el-tag  v-if="scope.row.status!='1'" type='info' >普通文章</el-tag >
          <el-tag  v-if="scope.row.status=='1'"  type='danger' >热点文章</el-tag >
        </template>
      </el-table-column>
       <el-table-column width="110px" align="center" label="显示状态">
        <template slot-scope="scope">
...
<script>
import { fetchList,Delete} from '@/api/article'

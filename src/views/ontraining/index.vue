  ...
  <div class="app-container">
    <el-table :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border fit highlight-current-row
      ...
      <el-table-column width="150px" label="logo">
        <template slot-scope="scope">
          ...
          <el-tag>{{scope.row.type}}</el-tag> -->
           <img width="100px" :src="image_prefix+scope.row.logo" class="avatar">
        </template>
      </el-table-column>
      <el-table-column width="110px" align="center" label="讲课老师">
       ...
       <!-- <el-table-column width="110px" align="center" label="报名时间">
        <template slot-scope="scope">
        <span>{{scope.row.apply_time}}</span>
        </template>
      </el-table-column>
          <el-table-column width="110px" align="center" label="截止时间">
        <template slot-scope="scope">
     ...
     <span>{{scope.row.code}}</span>
      ...
      <el-table-column align="center" label="操作" min-width="230" class-name="small-padding fixed-width">
        ...
        <el-button  size="mini" width="none" type="info" >已报名</el-button>
          ...
          <router-link :to="'/training/edit/'+scope.row.id">

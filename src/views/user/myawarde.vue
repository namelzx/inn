...
<div class="app-container">
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border fit highlight-current-row
      ...
      <el-table-column class-name="status-col" label="状态" width="100">
        ...
        <template slot-scope="scope">
          <el-tag  type="danger">{{scope.row.user_name}}</el-tag>
          <!-- <el-tag  v-if="scope.row.awarded==1">已分配</el-tag> -->
        </template>
      </el-table-column>
         <el-table-column class-name="status-col" label="推荐人" width="100">
        <template slot-scope="scope">
...
<script>
import { UserList,statusUser, updateArticle,setUserbyUpdate,SetByType ,PostAwardedByData,GetAwardeByList,GetRedfedeByFind,SetRedfeByAdd} from '@/api/user'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      GetAwardeByList(this.listQuery).then(response => {
        console.log(response);

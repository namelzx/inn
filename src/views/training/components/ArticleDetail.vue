                 ...
                 <el-col :span="8">
                  ...
                  <el-col :span="8">
                    ...
                    <el-input v-model="postForm.price" placeholder="不输入即免费"></el-input>
                      ...
                      <el-col :span="8">
                      <el-form-item label-width="100px" label="可报名人数:" class="postInfo-container-item">

                    <el-input v-model="postForm.willnum" placeholder=" "></el-input>

                  </el-form-item>
             </el-col>

                  <el-col :span="8">
                      <el-form-item label-width="100px" label="签到码:" class="postInfo-container-item">

                    <el-input v-model="postForm.code" placeholder=" "></el-input>
